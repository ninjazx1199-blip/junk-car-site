  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-white">
      ...
      <section className="max-w-5xl mx-auto px-4 py-6">
        <img
          src="https://cdn.jsdelivr.net/gh/ninjazx1199-blip/junk-car-site@main/hero-top-dollar.jpg"
      ...
      <section className="max-w-5xl mx-auto px-4 pb-8">
        ...
        <div className="bg-[#111111] rounded-[32px] border border-yellow-500/10 p-4 md:p-6 shadow-2xl">
          <img
            src="https://cdn.jsdelivr.net/gh/ninjazx1199-blip/junk-car-site@main/promo-top-dollar.jpg"
